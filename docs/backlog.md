...
**Статус: в работе.** Программный срез и последние UX-корректировки реализованы; локальная acceptance подтверждена владельцем. Домен выбран; deployment и HTTPS ещё не выполнены. Подробности — [auth и acceptance](stage-2-auth.md).
